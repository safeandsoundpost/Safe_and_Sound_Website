...
“Nothing brings me more joy than bringing a director's vision to life!”`,
    ...
    {
        name: "Bronwen Spolsky",
        column: 2,
        order: 4,
        mobileColumn: 5,
        mobileRow: 2,
        role: "Freelance Dialogue Editor / SFX Editor / Foley Artist",
        pic: "bronwen",
        bio: "Bronwen is a Toronto Metropolitan University alum with experience in both location and post-production sound across narrative, documentary, commercial, and reality productions. As a freelance collaborator with Safe & Sound Post, she specializes in dialogue editing, sound effects editing, and foley, bringing a detail-oriented approach to every project.",
        favFilm: "Swiss Army Man",
        filmLabel: "🧔💨🛶",
        imdb: "https://www.imdb.com/name/nm12715054/",
    },
    {
        name: "Levi Considine",
        column: 2,
        ...
        role: "Sound Designer",
        pic: "levi",
        bio: `With over 12 years of experience in professional audio, Levi Considine is an award-winning sound designer specializing in film and television post-production. A graduate of The Ontario Institute of Audio Recording Technology, he completed the program by age 19 before returning the following year to help teach the next generation of audio professionals. Since then, he has built a career creating immersive soundscapes, enhancing storytelling through detailed sound design, and delivering polished mixes for broadcast, streaming, and independent productions.

Levi's work has earned industry recognition, including a Canadian Screen Award (CSA) for Best Sound. While his primary focus is film and television post-production, his experience also extends into game audio, giving him a versatile approach to crafting impactful sonic experiences across multiple mediums. He particularly enjoys working on psychological thrillers, cinematic trailers, and unscripted television, where thoughtful sound design can heighten emotion, reinforce storytelling, and bring every scene to life. Whether creating subtle atmospheres or cinematic moments, his goal is always to elevate the audience's experience through creative, story-driven sound.`,
        favFilm: "There Will Be Blood",
        filmLabel: "I drink your milkshake! 🥤🛢️",
        imdb: "https://www.imdb.com/name/nm6346683/",
    },
    // {
